...
const historyUiPath = path.join(__dirname, "..", "ui", "history.js");
...
const historyUiSource = fs.readFileSync(historyUiPath, "utf8");
...
vm.runInContext(historyUiSource, context, { filename: "ui/history.js" });
